...
module.exports = {
    ...
    addTpCart: async (req, res) => {
        ...
        if (find_cart) {
            var prodincart = find_cart.product.some((item) => item.productId == req.body.product[0].productId);
            ...
            if (prodincart === true) {
                ...
                var objIndex = myArray.findIndex(obj => obj.productId == req.body.product[0].productId);
