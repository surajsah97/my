...
const validationSchema = Joi.object({
  ...
  registrationZone: Joi.number().required(),
  registrationDate: Joi.date().required(),
  vehicleColor: Joi.string().required(),
  vehicleYear: Joi.date().required(),
  vehicleAge: Joi.number().required(),
  chasisNumber: Joi.string().required(),
  bikeInsuranceValidity: Joi.date().required(),
  fitnessValidity: Joi.date().required(),
  mulkiyaValidity: Joi.date().required(),
  ...
  emiratesIdValidity: Joi.date().required(),
