...
router.route("/").get(Auth.validateTokenTruckDriver, errorfun(TruckDriver.getTruckDriverProfile));

router.route("/login").post( errorfun(TruckDriver.loginTruckDriver));

router.route("/changepassword").post(Auth.validateTokenTruckDriver, errorfun(TruckDriver.changePass));
