...
router.post("/addSubscription", Auth.adminValidateToken,errorfun(userSubscription.addSub))
router.post("/updateSubscription", errorfun(userSubscription.updateSub))
router.post("/updateSubscription", Auth.adminValidateToken,errorfun(userSubscription.updateSub))
